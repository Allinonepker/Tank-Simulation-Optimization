...
class Game
{
  public:
    ...
    vector<Tank&> merge_sort_tanks_health(const std::vector<Tank>& original);
    vector<Tank&> merge_sort_tanks_health(const std::vector<Tank>& original, int low, int high);
    void quick_sort_tanks_health(const std::vector<Tank>& original, int l, int r);
    void merge(const std::vector<Tank>& original, int low, int high, int mid);
