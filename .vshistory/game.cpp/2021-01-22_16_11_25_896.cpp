...
//vector<Tank*> Tmpl8::Game::quickSort(vector<Tank*> arr, int start, int end) {
...
//}
//
//int Tmpl8::Game::partition(vector<Tank*> arr, int start, int end) {
